...
<template>
  ...
  <main class>
    <section id="hero" class="hero-section relative w-full min-h-screen overflow-hidden flex items-center justify-center pt-30 pb-15">
    ...
    <footer class="site-footer w-full p-[80px_20px_40px_20px] bg-transparent mt-10 border-t-0">
         <div class="footer-content max-w-200 mx-auto flex flex-col items-start gap-10 mb-15 text-left">
             ...
             <div class="footer-brand-row max-w-150 flex flex-col items-start text-left">
                 <img src="/images/logodark.svg" alt="Logo" class="h-7 mb-5 w-auto block dark:hidden">
                 <img src="/images/logolight.svg" alt="Logo" class="h-7 mb-5 w-auto hidden dark:block">
